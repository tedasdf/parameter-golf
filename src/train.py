...
from src.constant import CONTROL_TENSOR_NAME_PATTERNS, INT8_CLIP_Q, INT8_KEEP_FLOAT_FP32_NAME_PATTERNS, INT8_KEEP_FLOAT_MAX_NUMEL, INT8_KEEP_FLOAT_STORE_DTYPE, INT8_PER_ROW_SCALE_DTYPE
from src.data_load import DistributedTokenLoader, load_validation_tokens
import torch
...
# how to store tensors that are not being quantised
...
def main() -> None:
    ...
    while True:
        ...
        train_tokens_processed += int(args.train_batch_tokens)
